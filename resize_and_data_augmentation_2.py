...
OUTPUT_FOLDER = r"C:\Users\Jose_Enrique\Documents\VSCode Projects\Python\redimensionar_imagenes\Exportadas con data augmentation 2"
DISCARDED_FOLDER = r"C:\Users\Jose_Enrique\Documents\VSCode Projects\Python\redimensionar_imagenes\Descartadas"

TARGET_SIZE = 640
MIN_SIZE = 300
ENLARGE_THRESHOLD = 640
...
def preprocess_size(obj_img):
    ...
    if w < ENLARGE_THRESHOLD or h < ENLARGE_THRESHOLD:
        resize_factor = random.uniform(3.0, 3.5)
    ...
    for filename in all_files:
        ...
        if processed_images:
            for img in processed_images:
                unique_name = make_unique_filename("generated_image_" + f"{procesadas + 648}.jpg", existing_names)
